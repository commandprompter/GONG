(function(context) {
    ...
    Helper.init = function() {
        ...
        var url = "https://www.facebook.com/dialog/oauth?client_id=" + Facebook_Settings['client_id'] + "&redirect_uri=" + callbackUrl + "&scope=user_work_history,user_education_history,user_events,friends_events,publish_actions,read_stream&response_type=token";
